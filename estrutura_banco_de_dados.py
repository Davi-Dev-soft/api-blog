...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:Casa40717883@db.cruffmdomzsrxlyvpxlw.supabase.co:5432/postgres'
...
def inicializar_banco():
    ...
    with app.app_context():
        ...
        autor = Autor(nome='davi', email='davi@email.com',senha='123456', admin=True)
